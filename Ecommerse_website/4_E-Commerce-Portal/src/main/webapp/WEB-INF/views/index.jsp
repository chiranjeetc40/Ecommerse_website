...
html, body {
	...
	background-image:
		url("https://wallpapercave.com/wp/wp2646214.jpg");
...
<body class="overPage">
						...
						<div class="modal-body">
							<div class="input-group ">
								<span class="input-group-btn"> </span><label>Quantity</label> <input
									...
									class="form-control input-number modeldata" min="1"> <br>
								<br> <span class="input-group-btn"> </span><label>Zip
									Code</label> <input type="text" id="zipcode"
									class="form-control input-number modeldata"
									pattern="[1-9][0-9]{5}"> <br> <br>
						...
						<div class="modal-body">
							<div class="input-group">
								<span class="input-group-btn"> </span> <label>Quantity</label> <input
									...
									class="form-control input-number modeldata" min="1" max="10">
								<br> <br>
	...
	function addToCart() {
		...
		var zipCode=document.getElementById("zipcode").value;
	      ...
	      if (x <= 0) { // quantity check failed
	        alert('qty invalid');
	        return;
	      }
	      if (zipCode.length != 6) { // zipCode length check failed
	        alert('zipCode invalid');
	        return;
	      }
	      if (!checkIfAllDigit(zipCode)) { // zipCode format check failed
	        alert('zipCode validation failed for format');
	        return;
	      }
